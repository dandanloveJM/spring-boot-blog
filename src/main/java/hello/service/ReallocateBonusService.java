...
//
//                    if(team.equals("Z")) {
//                        teamProductsMap.put("Z1", user.getUserReallocateProduct().divide(divisor, RoundingMode.CEILING));
//                        teamProductsMap.put("Z2", user.getUserReallocateProduct().divide(divisor, RoundingMode.CEILING));
//                    } else if (team.equals("F")){
//                        teamProductsMap.put("F1", user.getUserReallocateProduct().divide(divisor, RoundingMode.CEILING));
//                        teamProductsMap.put("F2", user.getUserReallocateProduct().divide(divisor, RoundingMode.CEILING));
//                    } else {
