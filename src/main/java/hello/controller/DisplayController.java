...
public class DisplayController {
    ...
    public ProjectListResult getR3UnfinishedProjects(Integer userId,
        ...
        return displayService.getUnfinishedR3Projects(userId, query, year, type, number, startDate, endDate);
    }
    ...
    public ProjectListResult getR4FinishedProjects(Integer userId,
        ...
        return displayService.getR4FinishedProjects(userId, query, year, type, number, startDate, endDate, page, pageSize);
    }
